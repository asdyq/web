...
if ($_SERVER["REQUEST_METHOD"] == 'GET')
{
    ...
    $id = $_GET['id'];
    $sql = "select * from lab_5 where id=$id";
...
else
{
    ...
    $sql = "update lab_5 set name='$name', price='$price', description='$description' where id='$id'";
    $result = $conn->query($sql);
}
?>
<!DOCTYPE html>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="create.php">Add New</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <div class="col-lg-6 m-auto">
        <form method="post"><br><br>
            <div class="card">
                <div class="card-header bg-warning"><h1 class="text-white text-center">  Update Member </h1></div><br>
